  ...
  return (
    <div>
        ...
        <div className='p-3 d-flex gap-4 align-items-center'>
            <ConstraintField error={errors.objFuncA} value={a} onChange={onChange} onBlur={onBlur} number={1} name='objFuncA' />
            <span>+</span>
            <ConstraintField error={errors.objFuncB} value={b} onChange={onChange} onBlur={onBlur}  number={2} name='objFuncB' />
        </div>
        {(errors.objFuncA || errors.objFuncB) && <div className='justify-content-center d-flex'>
